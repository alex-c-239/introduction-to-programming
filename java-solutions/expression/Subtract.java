...
public class Subtract extends BinaryExpression implements Expression, TripleExpression, BigIntegerExpression {

    public Subtract(AnyExpression ex1, AnyExpression ex2) {
        super(ex1, ex2, "-");
    }
    ...
    public BigInteger evaluate(BigInteger x) {
        if (ex1 instanceof BigIntegerExpression && ex2 instanceof BigIntegerExpression) {
            return ((BigIntegerExpression) ex1).evaluate(x).subtract(((BigIntegerExpression) ex2).evaluate(x));
        }
